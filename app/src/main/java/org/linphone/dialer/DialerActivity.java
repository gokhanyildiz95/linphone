...
public class DialerActivity extends MainActivity implements AddressText.AddressChangedListener {
    ...
    private RelativeLayout mBackToCallContainer;
    ...
    private void initUI(View view) {
        ...
        mCallContainer = view.findViewById((R.id.call_container));
        ...
        mBackToCallContainer = view.findViewById(R.id.call_back_container);
    ...
    private void updateLayout() {
        ...
        mCallContainer.setVisibility(atLeastOneCall ? View.GONE : View.VISIBLE);
        ...
        mBackToCallContainer.setVisibility(atLeastOneCall ? View.VISIBLE : View.GONE);
