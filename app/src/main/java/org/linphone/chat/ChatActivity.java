...
public class ChatActivity extends MainActivity {
    ...
    public void showChatRoomWView(String url, boolean isChild) {
        Bundle extras = new Bundle();
        if (url != null) {
            extras.putString("TheUrl", url);
        }
        /*
        ChatMessagesFragmentWView fragment = new ChatMessagesFragmentWView();
        fragment.setArguments(extras);
        changeFragment(fragment, "Chat Message", isChild);
