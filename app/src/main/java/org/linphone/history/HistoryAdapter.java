...
import org.linphone.swipereveallayout.ViewBinderHelper;
...
public class HistoryAdapter extends SelectableAdapter<HistoryViewHolder> {
    ...
    public HistoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // sysLog.d("MOBILOG", "HistoryAdapter onCreateViewHolder() : " + v);
    ...
    public static class SimpleSwipeListener implements SwipeRevealLayout.SwipeListener {
        ...
        public SimpleSwipeListener(Address address) {
            this.address = address;
        }

        @Override
        public void onClosed(SwipeRevealLayout view) {
            Log.d("UMUT", "on closed");
        }
        ...
        public void onOpened(SwipeRevealLayout view) {
            ...
            if (this.address != null) {
                ...
                LinphoneManager.getCallManager()
                        .newOutgoingCall(address.asStringUriOnly(), displayName);
            }
        }
    ...
    */
    ...
    public void onBindViewHolder(@NonNull final HistoryViewHolder holder, final int position) {
        // Log.d("umut", "on bind holderpost " + holder.getAdapterPosition());
        ...
        // sysLog.d("MOBILOG", "HistoryAdapter onBindViewHolder() => contact : " + c);
        ...
        holder.detail.setOnClickListener(
                !isEditionEnabled()
                        ...
                        : null);
        // enable drag if edition not enabled

        // holder.mHistoryClick.setOnClickListener(v -> Log.d("UMUT", "history click"));
        /*
        if (!isEditionEnabled()) {
            viewBinderHelper.bind(holder.swipeLayout, address.asString());
            holder.swipeLayout.setSwipeListener(new SimpleSwipeListener(address));
        } else {
