...
public class CallOutgoingActivity extends LinphoneGenericActivity implements OnClickListener {
    ...
    protected void onResume() {
        ...
        sysLog.d("UMUT", "sett text = " + LinphoneUtils.getDisplayableAddress(address));
        sysLog.d("UMUT", "out adress = " + address.asString());
        sysLog.d("UMUT", "out adress get = " + address.getUsername());
        mNumber.setText(address.getUsername());
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.outgoing_hang_up) {
            sysLog.d("MOBILOG", "CallOutgoingActivity Outgoing Hang Up Clicked");
            decline();
        }
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (LinphoneContext.isReady()
            ...
            mCall.terminate();
            sysLog.d("MOBILOG", "CallOutgoingActivity onKeyDown Clicked");
            finish();
        }
    ...
    private void decline() {
        sysLog.d("MOBILOG", "CallOutgoingActivity decline()");
        mCall.terminate();
        finish();
    }
