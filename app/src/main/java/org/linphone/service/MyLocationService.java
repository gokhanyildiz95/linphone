...
public class MyLocationService extends Service {
    ...
    private class LocationListener implements com.google.android.gms.location.LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            tkHelper.storeLocation(mLastLocation.getLatitude(), mLastLocation.getLongitude());
        }
    }
    ...
    */
    ...
    LocationListener[] mLocationListeners =
            new LocationListener[] {new LocationListener(LocationManager.PASSIVE_PROVIDER)};
