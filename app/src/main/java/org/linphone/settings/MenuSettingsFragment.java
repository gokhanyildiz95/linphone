...
public class MenuSettingsFragment extends SettingsFragment {
    ...
    private void loadSettings() {
        ...
        mAudio.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_audio) ? View.GONE : View.VISIBLE);
        mVideo.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_video) ? View.GONE : View.VISIBLE);
        mCall.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_call) ? View.GONE : View.VISIBLE);
        mChat.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_chat) ? View.GONE : View.VISIBLE);
        mNetwork.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_network) ? View.GONE : View.VISIBLE);
        mAdvanced.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_advanced)
                        ? View.GONE
                        : View.VISIBLE);
        mContact.setVisibility(
                getResources().getBoolean(R.bool.settings_hide_contact) ? View.GONE : View.VISIBLE);
    }
