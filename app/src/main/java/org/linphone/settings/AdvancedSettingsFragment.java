...
public class AdvancedSettingsFragment extends SettingsFragment {
    ...
    private void loadSettings() {
        ...
        mShareLocation = mRootView.findViewById(R.id.pref_share_location);
        mShareLocation.setVisibility(
                getResources().getBoolean(R.bool.allow_share_location) ? View.VISIBLE : View.GONE);
    ...
    private void setListeners() {
        ...
        mRemoteProvisioningUrl.setListener(
                new SettingListenerBase() {
                    @Override
                    public void onBoolValueChanged(boolean newValue) {
                        mPrefs.setShareLocation(newValue);
                    }
                });
    ...
    private void updateValues() {
        ...
        if (Compatibility.isAppUserRestricted(getActivity())) {
            ...
            mBackgroundMode.setEnabled(true);
        ...
        mShareLocation.setChecked(mPrefs.isShareLocationEnabled());
